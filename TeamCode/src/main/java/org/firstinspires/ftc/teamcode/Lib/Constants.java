...
public class Constants {
    ...
    public static final int EXTENSION_SPIKE = 1450;
    ...
    public static final double OUTTAKE = -0.26;
    ...
    public static final double WRIST_SCORE_BUCKET = 0.27;
    ...
    public static final Vector2d BUCKET_POS = new Vector2d(49.5, 50);
