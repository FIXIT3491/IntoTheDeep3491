...
public class Constants {
    ...
    public static final double SPARKFUN_SPEED_GAIN =  0.05;   // 0.02 Forward Speed Control "Gain". eg: Ramp up to 50% power at a 25 inch error.   (0.50 / 25.0)
    public static final double SPARKFUN_STRAFE_GAIN =  0.1;   // 0.015 Strafe Speed Control "Gain".  eg: Ramp up to 25% power at a 25 degree Yaw error.   (0.25 / 25.0)
    ...
    public static final double SPARKFUN_MAX_AUTO_STRAFE = 0.55;   //  Clip the approach speed to this max value (adjust for your robot)
