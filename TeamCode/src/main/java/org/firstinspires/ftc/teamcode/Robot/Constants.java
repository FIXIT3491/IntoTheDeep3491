...
public class Constants {
    ...
    public static final double BUCKET_X = 11;   //  Position of the bucket forward value for the OTOS auto relative to the robot (adjust for your robot)
    public static final double BUCKET_Y = -22.5;   //  Clip the turn speed to this max value (adjust for your robot)
